...
namespace Abantwana_DayCare.Controllers
{
    ...
    public class UsersAdminController : Controller
    {
        ...
        public async Task<ActionResult> Create(StaffCreateVM userViewModel, params string[] selectedRoles)
        {
            if (ModelState.IsValid)
            {
                ...
                user.FullName = userViewModel.FirstName+" "+userViewModel;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Email,Id,Address,City,State,PostalCode,FirstName,LastName,Organization,Phone")] EditUserViewModel editUser, params string[] selectedRole)
        {
            if (ModelState.IsValid)
            {
